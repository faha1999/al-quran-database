      ...
      <div className="space-y-16">
        <section className="relative py-10">
          ...
          >
            ...
            <h1 className="bg-gradient-to-r from-white via-zinc-200 to-zinc-500 bg-clip-text text-5xl font-extrabold tracking-tight text-transparent md:text-6xl">
              One Dataset. <br />
        ...
        >
          {quickLinks.map((link) => (
            <Link key={link.title} href={link.href}>
              ...
              >
                <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-zinc-800/50 transition-colors group-hover:bg-blue-500/10">
                  {link.icon}
                </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-3xl border border-zinc-800 bg-black/60 p-1 backdrop-blur-xl">
              <div className="flex items-center gap-1.5 border-b border-zinc-800/50 px-4 py-3">
                ...
                <span className="ml-2 text-[10px] font-medium uppercase tracking-widest text-zinc-600">
                  bash
                </span>
              </div>
...
const data = await quran.getSurah(1, 'en.sahih');`}</code>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-3xl border border-zinc-800 bg-black/60 p-1 backdrop-blur-xl">
              ...
              <pre className="overflow-x-auto p-6 font-mono text-[13px] leading-relaxed text-zinc-400">
    ...
    knowledge {
      themes
        ...
        <section className="rounded-3xl border border-zinc-800 bg-gradient-to-br from-zinc-950 via-zinc-950 to-blue-900/10 p-10 text-center">
          <h2 className="mb-2 text-xl font-bold text-zinc-100">Production Ready.</h2>
