...
export default function DocsAyahsClient() {
  return (
    <DocsLayout>
      <div className="space-y-16 pb-20">
        <section className="space-y-4">
          ...
          >
            Deep access to individual Ayahs, word-by-word breakdowns, and scholarly metadata from
            the knowledge layer.
          </motion.p>
        </section>
        ...
        <div className="space-y-12">
          <section className="space-y-6">
            ...
            <p className="text-sm text-zinc-500">
              Fetch a specific Ayah using its absolute ID (1-6236). Supports translation and
              knowledge hydration.
            </p>
