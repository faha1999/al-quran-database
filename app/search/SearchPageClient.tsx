...
export default function SearchPageClient({
  ...
  const handleSearch = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await runSearch(query, edition, language);
  };
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] px-4 py-8 text-white md:px-12 md:py-12">
          ...
          {meta ? (
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-[10px] uppercase tracking-wider text-zinc-500 transition-colors hover:text-blue-400 self-start sm:self-auto"
              >
                Copy API
              </button>
            </div>
          ...
          {results.length > 0 ? (
            <div className="grid gap-6">
              {results.map((result) => (
                <article
                  key={result.id}
                  className="group rounded-2xl border border-zinc-800 bg-zinc-900/30 p-5 md:p-8 transition-all hover:border-zinc-700 hover:bg-zinc-900/50"
                >
                  ...
                  <div className="relative rounded-2xl border border-zinc-800/50 bg-black/30 p-6">
                    ...
                    <div className="mt-4 flex items-center justify-between border-t border-zinc-800/50 pt-4">
                      ...
                      <Link
                        ...
                        className="text-[10px] uppercase tracking-widest text-blue-500 transition-colors hover:text-blue-400"
                      >
                        View JSON Data
                      </Link>
                    </div>
